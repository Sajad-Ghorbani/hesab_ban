...
class UpdateCustomerBillUseCase
    extends AsyncUseCase<DataState<BillEntity>, BillParams> {
  final BillRepository _billRepository;

  UpdateCustomerBillUseCase(this._billRepository);

  @override
  Future<DataState<BillEntity>> call(BillParams params) {
    return _billRepository.updateCustomerBill(params);
  }
}